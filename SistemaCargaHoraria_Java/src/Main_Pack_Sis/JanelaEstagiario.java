...
public class JanelaEstagiario extends JFrame implements ActionListener {
	...
	public JanelaEstagiario () throws SQLException{
		...
		ListaEstagiarios.setBorder(BorderFactory.createTitledBorder("Lista de Estagiários"));
		...
		painelBotoes.setBorder(BorderFactory.createTitledBorder("Opções de Estagiário"));
